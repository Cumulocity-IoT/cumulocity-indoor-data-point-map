...
import { CoreModule, FormsModule, gettext, hookComponent } from '@c8y/ngx-components';
...
@NgModule({
  ...
  providers: [
    hookComponent({
      ...
      label: gettext('Indoor Datapoint Map Widget'),
      description: gettext('Display markers on a indoor map and their datapoints'),
